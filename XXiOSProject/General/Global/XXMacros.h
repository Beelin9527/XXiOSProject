...
#define M_KEY_WINDOW [UIApplication sharedApplication].keyWindow
#define M_TOP_SPACE IOS11_OR_LATER_SPACE(M_KEY_WINDOW.safeAreaInsets.top)
#define M_TOP_ACTIVE_SPACE IOS11_OR_LATER_SPACE(MAX(0, M_KEY_WINDOW.safeAreaInsets.top-20))
#define M_BOTTOM_SPACE IOS11_OR_LATER_SPACE(M_KEY_WINDOW.safeAreaInsets.bottom)
...
#define M_GET_CONTROLLER_FROM_STORYBOARD(storyboardName, controllerIdentifier)  [[UIStoryboard storyboardWithName:storyboardName bundle:nil] instantiateViewControllerWithIdentifier:controllerIdentifier];
#endif /* XXMacros_h */
