...
- (instancetype)init
{
    self = [super init];
    if (self) {
        self.frame = CGRectMake(0, 0, M_SCREEN_WIDTH, M_SCREEN_HEIGHT);
...
- (void)initPreviewLayer{
    ...
    self.previewLayer.frame = CGRectMake(0, 0, M_SCREEN_WIDTH, M_SCREEN_HEIGHT);
...
-(void)singleTap:(UITapGestureRecognizer *)tapGesture{
    ...
    NSLog(@"-------------------x=%f,y=%f",convertPoint.x,convertPoint.y);
    NSLog(@"+++++++++++++++++++x=%f,y=%f",cameraPoint.x,cameraPoint.y);
...
- (UIView *)focusCircleView{
    if (!_focusCircleView) {
        ...
        _focusCircleView.frame = CGRectMake(0, 40, M_SCREEN_WIDTH, M_SCREEN_HEIGHT - 150);
