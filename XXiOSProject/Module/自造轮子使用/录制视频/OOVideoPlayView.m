...
#define VIDEO_CROSS_HEIGHT 200*(M_SCREEN_HEIGHT/480.0)
@implementation OOVideoPlayView

#pragma mark - life Cycle
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        _porVertical = CGRectMake(0, 0, M_SCREEN_WIDTH, M_SCREEN_HEIGHT);
        _porCross = CGRectMake(M_SCREEN_HEIGHT/2.0 - VIDEO_CROSS_HEIGHT/2.0, 0, VIDEO_CROSS_HEIGHT, M_SCREEN_WIDTH);
        _lanVertical = CGRectMake(0, M_SCREEN_HEIGHT/2.0 - VIDEO_CROSS_HEIGHT/2.0, M_SCREEN_WIDTH, VIDEO_CROSS_HEIGHT);
        _lanCross = CGRectMake(0, 0, M_SCREEN_HEIGHT, M_SCREEN_WIDTH);
