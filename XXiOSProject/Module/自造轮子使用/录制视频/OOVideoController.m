...
- (OOVideoRecordView *)videoRecordView{
    if (!_videoRecordView) {
        ...
        _videoRecordView.frame = CGRectMake(0, 0, M_SCREEN_WIDTH, M_SCREEN_HEIGHT);
    }
...
- (UIImageView *)imv{
    if (!_imv) {
        ...
        _imv.frame = CGRectMake(0, 0, M_SCREEN_WIDTH, M_SCREEN_HEIGHT);
    }
    return _imv;
}
- (UIButton *)backBtn{
...
- (UIButton *)finishBtn{
    if (!_finishBtn) {
        ...
        _finishBtn.frame = CGRectMake(M_SCREEN_WIDTH - 50 - kBtnWidth, 300, kBtnWidth, kBtnHeight);
